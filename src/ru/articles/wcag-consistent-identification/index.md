...
description: Что такое консистентная идентификация на страницах и как не запутать пользователей инструкциями.
ogImage: cover.png
keyTheme:
  - WCAG
  - Дизайн
...
[На сайте gov.uk](http://gov.uk/) есть поиск с кнопкой с иконкой лупы на отдельных страницах и в меню. Иконки и сами кнопки выглядят одинаково, у них везде одно и то же скрытое название «Искать gov.uk» («Search GOV.UK»).

<figure class="article__image">
  <img
    class="article__image-item"
    src="images/govuk-first-page.png"
    alt="Кусочек интерфейса сайта с поисковой строкой в основной части страницы."
  >
...
<figure class="article__image">
  <img
    ...
    alt="Основное меню с полем поиска по сайту."
  >
  <figcaption class="article__image-caption">
...
[На Amazon](https://www.amazon.com/) на страницах с категориями товаров есть пагинация. В ней одинаковые по функциональности элементы с одинаковыми названиями в `aria-label` — «Current page, page 1», «Current page, page 2» и так далее. Для переключения между страницами есть стрелки «Вперёд» и «Назад», а также конкретные номера страниц.
...
<figure class="article__image">
  <img
    ...
    alt="Другая страница торговой площадки с пагинацией под списком товаров."
  >
  <figcaption class="article__image-caption">
