...
<figure>
  <img src="images/pass.png" alt="Хорошие примеры">
...
<figure>
	<img src="images/fail.png" alt="Плохие примеры">
	<figcaption>Элементы, которые нарушают оба критерия.</figcaption>
</figure>
...
<figure>
  <img src="images/pocket-site.png" alt="В меню выделена кнопка с иконкой в виде плюса. На неё наведён курсор с открытым инструментом разработчика.">
...
<figure>
  <img src="images/nrk-site.png" alt="Блок с информацией об авторе текста. Это литературный критик и автор нескольких книг для детей. Её имя Анна-Катрина Штрайм. Курсор в режиме разработчика наведён на ссылку с текстом «Напишите мне на почту».">
...
<figure>
  <img src="images/chanel-site.png" alt="Первый слайд в слайдере из четырёх. Открыт инструмент разработчика, курсор наведён на небольшую точку под слайдером. Другой курсор наведён на кнопку со стрелкой, указывающей влево.">
...
<figure>
  <img src="images/zara-site.png" alt="Открыто боковое меню со списком всех товаров. В режиме разработчика выделена ссылка «База».">
...
<figure>
  <img src="images/mango-site.png" alt="Курсор в режиме разработчика наведён на круглую кнопку бордового цвета.">
