...
{% note %}
  *Экранна лупа* — вспомогательный инструмент, увеличивающий отдельные области экрана.
{% endnote %}
...
**Превью ссылок в энциклопедии**. При фокусе на ссылках статей в Википедии появляются тултипы с картинками и текстом. Некоторые ссылки частично перекрываются раскрытой подсказкой. Тултип исчезает при переходе к новой ссылке и не закрывается с помощью <kbd>Esc</kbd>.
...
**Фиксированный хедер в блоге**. В [блоге Transcend](https://transcend.io/blog) хедер фиксируется при прокрутке страницы вниз и вверх. При перемещении с клавиатуры по странице ни один интерактивный элемент не скрывается за хедером.
...
**NHK World Japan и полупрозрачный куки-баннер**. На главной сайта телекомпании [NHK World Japan](https://www3.nhk.or.jp/nhkworld/) в нижней части экрана зафиксирован куки-баннер с полупрозрачным фоном. Некоторые интерактивные элементы частично скрываются за баннером, когда навигируешься по странице с клавиатуры.
...
**Сайт университета с немодальным куки-баннером**. На сайте [университета Стокгольма](https://www.su.se/) немодальное окно с информацией про куки выровнено по центру экрана.
...
- [Не даём прилипающим хедерам перекрыть элементы в фокусе](https://www.tpgi.com/prevent-focused-elements-from-being-obscured-by-sticky-headers/), TPGi

***

Спасибо [Ане](https://anaworks.online) за помощь с редактурой 💖
