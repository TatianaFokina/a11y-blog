...
Больше примеров проблемных интерфейсов есть в&nbsp;[«Your Interactive Makes Me Sick»](https://source.opennews.org/articles/motion-sick/) Эйлин Уэбб. Надеюсь, ваш вестибулярный аппарат выдержит это испытание лучше, чем&nbsp;мой.
...
👉 Разместите предупреждение об&nbsp;опасном контенте, если&nbsp;сомневаетесь. Это спасёт ситуацию на какое-то время. Можно даже временно исключить такую страницу из выдачи. Например, с&nbsp;помощью HTML:
